...
const T = {
  ...
  en: {
    ...
    'sol1.f3': 'Remote monitoring app',     'sol1.f4': '7-year full system warranty',
    ...
    'proj.sub': 'Real installations. Real results. Explore a selection of our most impactful off-grid energy deployments.',
    ...
    'proj1.title': 'Alpine Villa — Swiss Alps',
    'proj1.desc': '12 kWp bifacial array + 24 kWh LiFePO₄ bank. Full off-grid operation year-round including harsh alpine winters.',
    'proj2.title': 'Outback Farm — Queensland',
    'proj2.desc': '45 kWp ground-mount with 100 kWh BYD storage. Powers full farm irrigation, sheds, and 3-bedroom homestead.',
    'proj3.title': 'Telecom Array — Morocco',
    'proj3.desc': '20 kWp hybrid system + diesel backup powering 3 telecom towers in extreme desert heat. 99.99% SLA required.',
    'proj4.title': 'Pacific Island Eco-Resort — Fiji',
    'proj4.desc': 'Our largest residential deployment to date: 120 kWp Canadian Solar array with 240 kWh Pylontech storage. Powers an entire 20-villa eco-resort — zero diesel, zero grid, zero emissions.',
    ...
    'rev1.quote': "We've been 100% off-grid for 18 months now. Not a single outage. The Victron system Off Grid installed handles everything automatically — we don't even think about power anymore. Best investment we've ever made in the property.",
    'rev1.name': 'James & Maria Kowalski', 'rev1.role': 'HomeBase Pro — Colorado, USA',
    'rev2.quote': "We run a 400-acre property completely off-grid. The AgroGrid system powers our irrigation pumps, cold storage, workshop, and family home without a hiccup. The three-phase output was critical for us. Off Grid Systems delivered exactly what they promised.",
    'rev2.name': 'Tom Henderson', 'rev2.role': 'AgroGrid Elite — Queensland, Australia',
    'rev3.quote': "Our three telecom tower sites in Morocco had diesel running 24/7. Off Grid Systems replaced all of it with solar. Fuel costs dropped to zero and the SCADA integration means we see every watt in real time from our NOC in Paris. Incredible team.",
    'rev3.name': 'Sophie Beaumont', 'rev3.role': 'IndustrialCore — Telecom, Morocco',
  ...
  ru: {
    ...
    'sol1.f3': 'Приложение удалённого мониторинга', 'sol1.f4': 'Полная гарантия системы 7 лет',
    ...
    'proj.sub': 'Реальные установки. Реальные результаты. Изучите подборку наших самых значимых проектов.',
    ...
    'proj1.title': 'Альпийская вилла — Швейцарские Альпы',
    'proj1.desc': 'Массив 12 кВт бифациальных панелей + банк LiFePO₄ 24 кВт⋅ч. Полная автономная работа круглый год, включая суровые альпийские зимы.',
    'proj2.title': 'Ферма — Квинсленд',
    'proj2.desc': 'Наземный монтаж 45 кВт с накопителем BYD 100 кВт⋅ч. Питает фермерскую ирригацию, хозяйственные постройки и усадьбу.',
    'proj3.title': 'Телекоммуникационный массив — Марокко',
    'proj3.desc': 'Гибридная система 20 кВт + дизельный резерв для 3 телекоммуникационных башен в экстремальную жару. SLA 99,99%.',
    'proj4.title': 'Эко-курорт на тихоокеанском острове — Фиджи',
    'proj4.desc': 'Крупнейший жилой объект: массив Canadian Solar 120 кВт с накопителем Pylontech 240 кВт⋅ч. Весь эко-курорт на 20 вилл — без дизеля, без сети, без выбросов.',
    ...
    'rev1.quote': 'Мы полностью живём в автономном режиме уже 18 месяцев. Ни одного отключения. Система Victron управляет всем автоматически — мы вообще не думаем об электричестве. Лучшая инвестиция в нашу собственность.',
    'rev1.name': 'James & Maria Kowalski', 'rev1.role': 'HomeBase Pro — Колорадо, США',
    'rev2.quote': 'Мы управляем поместьем площадью 400 акров полностью в автономном режиме. Система AgroGrid питает ирригационные насосы, холодильные склады, мастерскую и семейный дом без сбоев. Трёхфазный выход был критически важен для нас.',
    'rev2.name': 'Tom Henderson', 'rev2.role': 'AgroGrid Elite — Квинсленд, Австралия',
    'rev3.quote': 'На трёх объектах телекоммуникационных башен в Марокко дизельные генераторы работали круглосуточно. Off Grid Systems заменили всё солнечной энергией. Затраты на топливо упали до нуля, а интеграция SCADA позволяет видеть каждый ватт в реальном времени. Невероятная команда.',
    'rev3.name': 'Sophie Beaumont', 'rev3.role': 'IndustrialCore — Телеком, Марокко',
  ...
  el: {
    ...
    'sol1.f3': 'Εφαρμογή απομακρυσμένης παρακολούθησης', 'sol1.f4': 'Πλήρης εγγύηση συστήματος 7 ετών',
    ...
    'proj.sub': 'Πραγματικές εγκαταστάσεις. Πραγματικά αποτελέσματα. Δείτε μια επιλογή από τα πιο σημαντικά έργα μας.',
    ...
    'proj1.title': 'Αλπική Βίλα — Ελβετικές Άλπεις',
    'proj1.desc': 'Συστοιχία 12 kWp διπλής όψης + τράπεζα LiFePO₄ 24 kWh. Πλήρης αυτόνομη λειτουργία καθ' όλη τη διάρκεια του έτους, συμπεριλαμβανομένων σκληρών αλπικών χειμώνων.',
    'proj2.title': 'Αγρόκτημα — Κουίνσλαντ',
    'proj2.desc': 'Εδαφική εγκατάσταση 45 kWp με αποθήκευση BYD 100 kWh. Τροφοδοτεί πλήρως άρδευση, αποθήκες και οικία 3 υπνοδωματίων.',
    'proj3.title': 'Συστοιχία Τηλεπικοινωνιών — Μαρόκο',
    'proj3.desc': 'Υβριδικό σύστημα 20 kWp + εφεδρικό ντίζελ για 3 πύργους τηλεπικοινωνιών σε ακραία ζέστη ερήμου. Απαιτούμενο SLA 99,99%.',
    'proj4.title': 'Οικολογικό Θέρετρο Νησιού του Ειρηνικού — Φίτζι',
    'proj4.desc': 'Η μεγαλύτερη ανάπτυξή μας: συστοιχία Canadian Solar 120 kWp με αποθήκευση Pylontech 240 kWh. Τροφοδοτεί ολόκληρο οικολογικό θέρετρο 20 βιλών — μηδέν ντίζελ, μηδέν δίκτυο, μηδέν εκπομπές.',
    ...
    'rev1.quote': 'Ζούμε 100% αυτόνομα για 18 μήνες τώρα. Ούτε μία διακοπή ρεύματος. Το σύστημα Victron χειρίζεται τα πάντα αυτόματα — δεν σκεφτόμαστε καν την ενέργεια πια. Η καλύτερη επένδυση στην ιδιοκτησία μας.',
    'rev1.name': 'James & Maria Kowalski', 'rev1.role': 'HomeBase Pro — Κολοράντο, ΗΠΑ',
    'rev2.quote': 'Διαχειριζόμαστε κτήμα 400 στρεμμάτων εξ ολοκλήρου αυτόνομα. Το σύστημα AgroGrid τροφοδοτεί αντλίες άρδευσης, ψυκτικές αποθήκες, εργαστήριο και οικογενειακό σπίτι χωρίς πρόβλημα. Η τριφασική έξοδος ήταν κρίσιμη.',
    'rev2.name': 'Tom Henderson', 'rev2.role': 'AgroGrid Elite — Κουίνσλαντ, Αυστραλία',
    'rev3.quote': 'Στους τρεις πύργους τηλεπικοινωνιών στο Μαρόκο είχαμε ντίζελ να τρέχει 24/7. Η Off Grid Systems αντικατέστησε τα πάντα με ηλιακή ενέργεια. Τα κόστη καυσίμων μηδενίστηκαν και η ενσωμάτωση SCADA μάς δείχνει κάθε watt σε πραγματικό χρόνο. Απίθανη ομάδα.',
    'rev3.name': 'Sophie Beaumont', 'rev3.role': 'IndustrialCore — Τηλεπικοινωνίες, Μαρόκο',
