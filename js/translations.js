...
const T = {
  ...
  en: {
    ...
    'hero.sub': 'Complete autonomous photovoltaic systems engineered for absolute reliability - European-made solar arrays, lithium battery storage, and smart inverters integrated for true energy independence.',
    ...
    'sol1.f3': 'Remote monitoring app',     'sol1.f4': '10-yr panel / 8-yr battery warranty', 'sol1.f5': 'European-made panels (Sweden & Italy)',
    ...
    'sol2.f3': 'Generator auto-start logic',  'sol2.f4': 'Load priority management', 'sol2.f5': 'European-made panels (Sweden & Italy)',
    ...
    'sol3.f3': '−40 °C rated operation',          'sol3.f4': 'DIY-friendly commissioning', 'sol3.f5': 'European-made panels (Sweden & Italy)',
    ...
    'sol4.f3': '24/7 remote NOC support',     'sol4.f4': 'Infinitely scalable racks', 'sol4.f5': 'European-made panels (Sweden & Italy)',
    ...
    'about.feat1.desc': "We specify solar panels made in Sweden and Italy, factory-authorised inverters, and proven lithium battery solutions from the world's leading manufacturers.",
  ...
  ru: {
    ...
    'hero.sub': 'Полные автономные фотоэлектрические системы, спроектированные для абсолютной надёжности - солнечные массивы европейского производства, литиевые аккумуляторы и умные инверторы для истинной энергетической независимости.',
    ...
    'sol1.f3': 'Приложение удалённого мониторинга', 'sol1.f4': 'Гарантия 10 лет панели / 8 лет АКБ', 'sol1.f5': 'Панели европейского производства (Швеция и Италия)',
    ...
    'sol2.f3': 'Автозапуск генератора',       'sol2.f4': 'Управление приоритетами нагрузки', 'sol2.f5': 'Панели европейского производства (Швеция и Италия)',
    ...
    'sol3.f3': 'Работа при −40 °C',            'sol3.f4': 'Простой монтаж своими руками', 'sol3.f5': 'Панели европейского производства (Швеция и Италия)',
    ...
    'sol4.f3': 'Удалённая поддержка NOC 24/7',    'sol4.f4': 'Бесконечно масштабируемые стойки', 'sol4.f5': 'Панели европейского производства (Швеция и Италия)',
    ...
    'about.feat1.desc': 'Мы используем солнечные панели производства Швеции и Италии, заводские инверторы и проверенные решения литиевых аккумуляторов от ведущих мировых производителей.',
  ...
  el: {
    ...
    'hero.sub': 'Πλήρη αυτόνομα φωτοβολταϊκά συστήματα σχεδιασμένα για απόλυτη αξιοπιστία - ηλιακές διατάξεις ευρωπαϊκής κατασκευής, αποθήκευση λιθίου και έξυπνοι μετατροπείς για πραγματική ενεργειακή ανεξαρτησία.',
    ...
    'sol1.f3': 'Εφαρμογή απομακρυσμένης παρακολούθησης', 'sol1.f4': 'Εγγύηση 10 ετών πάνελ / 8 ετών μπαταρίας', 'sol1.f5': 'Πάνελ ευρωπαϊκής κατασκευής (Σουηδία & Ιταλία)',
    ...
    'sol2.f3': 'Αυτόματη εκκίνηση γεννήτριας', 'sol2.f4': 'Διαχείριση προτεραιότητας φορτίου', 'sol2.f5': 'Πάνελ ευρωπαϊκής κατασκευής (Σουηδία & Ιταλία)',
    ...
    'sol3.f3': 'Λειτουργία σε −40 °C',            'sol3.f4': 'Εύκολη εγκατάσταση DIY', 'sol3.f5': 'Πάνελ ευρωπαϊκής κατασκευής (Σουηδία & Ιταλία)',
    ...
    'sol4.f3': 'Απομακρυσμένη υποστήριξη NOC 24/7', 'sol4.f4': 'Άπειρα επεκτάσιμα ράφια', 'sol4.f5': 'Πάνελ ευρωπαϊκής κατασκευής (Σουηδία & Ιταλία)',
    ...
    'about.feat1.desc': 'Χρησιμοποιούμε ηλιακά πάνελ κατασκευής Σουηδίας και Ιταλίας, εξουσιοδοτημένους μετατροπείς και αξιόπιστες λύσεις μπαταριών λιθίου από τους κορυφαίους κατασκευαστές.',
